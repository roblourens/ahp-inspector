...
- [x] **FOUND-01**: Developer can install dependencies and run a standalone local AHP Inspector from the CLI.
...
- **EXT-01**: User can open AHP Inspector as a VS Code extension/webview.
