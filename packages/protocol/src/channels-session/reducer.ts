 ...
 */
function withInputNeededStatus(
 ...
 */
function applyCustomizationEnablement(
...
function applyCustomizationEnablement(
  customization: Customization | ChildCustomization,
  enablement: readonly CustomizationEnablement[],
): Customization | ChildCustomization {
  ...
  switch (action.type) {
    ...
    case ActionType.SessionInputNeededRemoved: {
      ...
      const next: SessionState = {
        ...state,
        status: withInputNeededStatus(state.status, remaining),
      };
