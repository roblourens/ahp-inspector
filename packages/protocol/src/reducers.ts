      ...
      return refreshSummaryStatus(
        updateToolCallInParts(state, action.turnId, action.toolCallId, (tc) => {
          ...
          const selectedOption =
            tc.status === ToolCallStatus.Running ? tc.selectedOption : undefined;
...
export function isClientDispatchable(
  action: RootAction | SessionAction | TerminalAction,
): action is ClientRootAction | ClientSessionAction | ClientTerminalAction {
