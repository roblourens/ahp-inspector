...
type _ExpectedClientNotifications = "unsubscribe" | "dispatchAction";
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
type _CheckClientNotificationMapKeys = _Exact<
  keyof ClientNotificationMap,
  _ExpectedClientNotifications
>;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
type _CheckServerNotificationMapKeys = _Exact<
  keyof ServerNotificationMap,
  _ExpectedServerNotifications
>;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
type _CheckClientNotificationsHaveChannel =
  _AllNotificationParamsHaveChannel<ClientNotificationMap> extends true ? true : never;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
type _CheckServerNotificationsHaveChannel =
  _AllNotificationParamsHaveChannel<ServerNotificationMap> extends true ? true : never;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
type _CheckServerCommandsHaveChannel =
  _AllParamsHaveChannel<ServerCommandMap> extends true ? true : never;
